...
export default function CookMode({ recipe, onClose, language = "en-US" }) {
  ...
  const speak = (text) => {
    ...
    // ⭐ Use the language passed from parent
...
const styles = {
  ...
  modal: {
    ...
    maxWidth: "560px", maxHeight: "90vh", overflowY: "auto", padding: "24px",
  },
  ...
  stepBox: {
    ...
    background: "#fff8f5", borderRadius: "16px", padding: "20px", marginBottom: "20px",
  },
  stepNumber: {
    background: "#ff6b35", color: "#fff", width: "36px", height: "36px",
    borderRadius: "50%", display: "flex", alignItems: "center",
    justifyContent: "center", fontWeight: "bold", flexShrink: 0, fontSize: "1rem",
  },
  ...
  repeatBtn: {
    flex: 1, padding: "12px", background: "#fff3ee", color: "#ff6b35",
    border: "1px solid #ff6b35", borderRadius: "10px", cursor: "pointer",
    fontWeight: "bold", fontSize: "1rem",
  },
